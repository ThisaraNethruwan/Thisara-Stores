...
export default function OrderSuccess() {
  ...
  const isPaid     = method === 'card'import { Link, useLocation } from 'react-router-dom'
...
export default function OrderSuccess() {
  ...
  return (
    <>
      <style>{`
        /* Hide the global footer for this page only */
        footer, .footer, #footer { display: none !important; }

        /* Increased min-height to 100vh to keep it perfectly centered without the footer */
        .os-page { min-height:100vh; background:#fffbf0; display:flex; align-items:center; justify-content:center; padding:40px 20px; }
